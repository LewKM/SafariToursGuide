...
<head>
    <meta charset="utf-8">
    <title>Safari Tours Guide</title>
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="" name="keywords">
    <meta content="" name="description">

    <!-- Favicon -->
    <link href="img/turaco.ico" rel="icon">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top py-lg-0 px-4 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
        <a href="index.html" class="navbar-brand p-0">
            <img class="img-fluid me-3" src="img/turaco.ico" alt="Icon">
            <h1 class="m-0 text-primary">Safari Tours Guide</h1>
        </a>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="h-100 bg-light d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">123 Street, Nairobi, Kenya</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="h-100 bg-light d-flex align-items-center p-5">
                        ...
                        <div class="ms-4">
                            ...
                            <h5 class="mb-0">info@safaritoursguide.com</h5>
                        </div>
                    </div>
                </div>
            </div>
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <form id="contactForm" action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST">
                        ...
                        <div id="step2">
                            <div class="row g-3">
                                <h4 class="text-primary"><span class="text-dark me-2">#</span>Number of Clients:</h4>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select bg-light border-0 text-center" id="rooms" name="rooms" value="<?php if(isset($rooms)) echo $rooms; ?>">
                                        ...
                                        <option value="Double Bed Rooms">Double Bed Rooms</option>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select class="form-select bg-light border-0 text-center" id="budget" name="budget" value="<?php if(isset($budget)) echo $budget; ?>">
                                        ...
                                        <option value="$4,000 per person">$4,000 per Person</option>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>info@safaritoursguide.com</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p>Unlock exclusive offers and stories. Join our newsletter today!</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">Safari Tours Guide</a>, All Rights Reserved.
                    </div>
                    <div class="col-md-6 text-center text-md-end">
                        Designed By <a class="border-bottom" href="https://www.linkedin.com/in/lewis-mwendwa-3a2581244/">LewKM</a>
                    </div>
                </div>
            </div>
        </div>
